...
/***/ function(module, exports, __webpack_require__) {
	...
	var _howler = __webpack_require__(/*! howler */ 168);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: 'getSnare',
	    value: function getSnare(i) {
	      return this.state.timeSig === '4/4' && i % 4 === 2 || this.state.timeSig === '3/4' && i % 6 !== 0 && i % 2 == 0 || this.state.timeSig === '6/8' && i % 6 === 3 || this.state.timeSig === '4/2' && i % 2 === 1;
	    }
	  }, {
	    key: 'getKick',
	    value: function getKick(i) {
	      return this.state.timeSig === '4/4' && i % 4 === 0 || this.state.timeSig === '3/4' && i % 6 === 0 || this.state.timeSig === '6/8' && i % 6 === 0 || this.state.timeSig === '4/2' && i % 2 === 0;
	    }
	  }, {
	    key: 'getHat',
	    value: function getHat(i) {
	      return this.state.timeSig === '4/4' && i % 2 === 0 || this.state.timeSig === '3/4' && i % 2 === 0 || this.state.timeSig === '6/8' && i % 3 === 0 || this.state.timeSig === '4/2';
	    }
	  }, {
	    key: 'getInput',
	    ...
	    key: 'addBarFill',
	    value: function addBarFill(input) {
	    ...
	    key: 'generateDotRow',
	    value: function generateDotRow(text) {
	      var charIndex = 0;
	      var dots = [];
	      while (charIndex < text.length) {
	        ...
	        if ((this.state.fillBars || this.state.drums) && this.state.showAdvanced && this.getKick(charIndex)) {
	          dots.push(_react2.default.createElement('div', { key: charIndex, className: 'dot', style: Object.assign({ backgroundColor: 'red' }, style) }));
	        } else if ((this.state.fillBars || this.state.drums) && this.state.showAdvanced && this.getSnare(charIndex)) {
	          dots.push(_react2.default.createElement('div', { key: charIndex, className: 'dot', style: Object.assign({ backgroundColor: 'blue' }, style) }));
	        } else {
	          dots.push(_react2.default.createElement('div', { key: charIndex, className: 'dot', style: Object.assign({ backgroundColor: 'lightGrey' }, style) }));
	        }
	        charIndex++;
	      }
	      return dots;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'input-box' },
	          _react2.default.createElement('textarea', { autoComplete: 'off', autoCorrect: 'off', autoCapitalize: 'off', spellCheck: false,
	            ...
	            onChange: function onChange(e) {
	              document.getElementById("textbox").value = _this3.formatText(e.target.value);
	            }
	          }),
	          this.dotsOverlay
	        ),
	    ...
	    get: function get() {
	      ...
	      var actualInput = this.addBarFill(this.getInput());
	      var lines = actualInput.split('\n');
	      var output = [];
	      lines.forEach(function (lineElement, lineIndex) {
	        output.push(_react2.default.createElement(
	          'div',
	          { key: lineIndex, className: 'dot-row' },
	          _this4.generateDotRow(lineElement)
	        ));
	      });
	    ...
	    get: function get() {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', {
	              ...
	              onChange: function onChange(e) {
	                _this5.setState({ drums: e.target.checked });
	              }
	            })
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'radio',
	              ...
	              onChange: function onChange(e) {
	                _this5.setState({ timeSig: e.target.value });
	              } }),
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'p',
	              null,
	              'Fill partial measures'
	            ),
	            _react2.default.createElement('input', {
	              type: 'checkbox',
	              checked: this.state.fillBars,
	              onChange: function onChange(e) {
	                _this5.setState({ fillBars: e.target.checked });
	              }
	            })
	          )
	        );
	      ...
	      return _react2.default.createElement(
	        ...
	        { className: 'link-button', onClick: function onClick() {
	            _this5.setState({ showAdvanced: true, drums: true, fillBars: true });
	          } },
	        'Advanced features'
	      );
	    }
